...
import { Plus, Search, Filter, Edit, Trash2, Eye, Package, CheckCircle, AlertTriangle, XCircle, FileText, Truck, Building, Shield, Leaf, Wrench } from "lucide-react";
  ...
  return (
    <DashboardLayout>
      <div className="p-8 space-y-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground">Materials Section</h1>
        </div>
        ...
        <div className="flex items-center text-sm text-muted-foreground mb-6">
          ...
          <span className="text-foreground font-medium">Materials Section</span>
        </div>
              ...
              <div className="p-4 border border-border rounded-lg hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">35 materials</p>
                  </div>
                </div>
              ...
              <div className="p-4 border border-border rounded-lg hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">22 materials</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <button className="p-2 hover:bg-muted rounded-lg transition-colors">
              ...
              <div className="p-4 border border-border rounded-lg hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">28 materials</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <button className="p-2 hover:bg-muted rounded-lg transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="p-4 border border-border rounded-lg">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">Used by: 32 materials</span>
                  <div className="flex items-center gap-2">
              ...
              <div className="p-4 border border-border rounded-lg">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">Used by: 18 materials</span>
                  <div className="flex items-center gap-2">
                    <button className="p-1 hover:bg-muted rounded transition-colors">
                      <Edit className="w-4 h-4 text-blue-500" />
                    </button>
              ...
              <div className="p-4 border border-border rounded-lg">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">Used by: 22 materials</span>
                  <div className="flex items-center gap-2">
                    <button className="p-1 hover:bg-muted rounded transition-colors">
                      <Edit className="w-4 h-4 text-blue-500" />
                    </button>
              ...
              <div className="p-4 border border-border rounded-lg">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="font-semibold text-foreground">Cubic Meters</h3>
                  <span className="px-2 py-1 bg-teal-100 text-teal-700 rounded-full text-xs font-medium">
                    Volume
                  </span>
                </div>
                <p className="text-sm text-muted-foreground mb-3">Volume measurement</p>
                <div className="flex items-center justify-between">
          ...
          <div className="bg-card rounded-xl p-6 shadow-card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="p-4 border border-border rounded-lg hover:shadow-md transition-shadow">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">35 materials</span>
                  <div className="flex items-center gap-2">
                    <button className="p-2 hover:bg-muted rounded-lg transition-colors">
              ...
              <div className="p-4 border border-border rounded-lg hover:shadow-md transition-shadow">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">22 materials</span>
                  <div className="flex items-center gap-2">
                    <button className="p-2 hover:bg-muted rounded-lg transition-colors">
                      <Eye className="w-4 h-4 text-blue-500" />
                    </button>
              ...
              <div className="p-4 border border-border rounded-lg hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground">Tool Masters Inc</h3>
                    <p className="text-sm text-muted-foreground">Tools & equipment</p>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">28 materials</span>
                  <div className="flex items-center gap-2">
                    <button className="p-2 hover:bg-muted rounded-lg transition-colors">
                      <Eye className="w-4 h-4 text-blue-500" />
                    </button>
              ...
              <div className="p-4 border border-border rounded-lg hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground">Eco Materials Co</h3>
                    <p className="text-sm text-muted-foreground">Environmental materials</p>
                  </div>
                </div>
                <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-4">
                ...
                <select className="px-3 py-2 border border-border rounded-lg bg-background text-foreground">
                  ...
                  <option>Steel Materials</option>
                  <option>Tools & Equipment</option>
                  <option>Environmental Materials</option>
                </select>
                <select className="px-3 py-2 border border-border rounded-lg bg-background text-foreground">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-border">
                    <td className="px-6 py-4 text-sm text-foreground">#MAT-004</td>
                    <td className="px-6 py-4 text-sm text-foreground">Drill Machine</td>
                    ...
                    <td className="px-6 py-4 text-sm text-muted-foreground">Pieces</td>
                    <td className="px-6 py-4 text-sm text-muted-foreground">Tool Masters Inc</td>
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        <button className="p-2 hover:bg-muted rounded-lg transition-colors">
                          <Eye className="w-4 h-4 text-blue-500" />
        ...
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-6">Materials Statistics</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-card rounded-xl p-6 shadow-card">
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-500 mb-2">108</div>
