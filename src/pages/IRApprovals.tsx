...
import { Plus, Search, Filter, Edit, Trash2, Eye, CheckCircle, XCircle, Clock, FileText, User, Calendar, AlertTriangle, Shield, Building } from "lucide-react";
  ...
  return (
    <DashboardLayout>
      <div className="p-8 space-y-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground">IR Approvals</h1>
        </div>
        ...
        <div className="flex items-center text-sm text-muted-foreground mb-6">
          ...
          <span className="text-foreground font-medium">IR Approvals</span>
        </div>

        {/* Approvals (IR) Section */}
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-6">Approvals (IR)</h2>
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-4">
                <div className="relative">
                  ...
                  <input 
                    type="text" 
                    placeholder="Search IR approvals..." 
              ...
              <table className="w-full">
                <thead className="bg-muted">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left text-sm font-medium text-muted-foreground">Inspection Type</th>
                ...
                <tbody>
                  <tr className="border-b border-border">
                    ...
                    <td className="px-6 py-4 text-sm text-muted-foreground">Structural Inspection</td>
                  ...
                  <tr className="border-b border-border">
                    ...
                    <td className="px-6 py-4 text-sm text-muted-foreground">Safety Inspection</td>
                    <td className="px-6 py-4">
                  ...
                  <tr className="border-b border-border">
                    ...
                    <td className="px-6 py-4 text-sm text-muted-foreground">Quality Inspection</td>
                    <td className="px-6 py-4">
                  ...
                  <tr className="border-b border-border">
                    ...
                    <td className="px-6 py-4 text-sm text-muted-foreground">Environmental Inspection</td>
                    <td className="px-6 py-4">
        ...
        {/* Approved (IR) Section */}
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-6">Approved (IR)</h2>
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-4">
                <div className="relative">
                  ...
                  <input 
                    type="text" 
                    placeholder="Search approved IRs..." 
                    className="pl-10 pr-4 py-2 border border-border rounded-lg bg-background text-foreground w-64"
                  />
                </div>
                <select className="px-3 py-2 border border-border rounded-lg bg-background text-foreground">
              ...
              <div className="p-6 border border-border rounded-lg hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-foreground">#IR-002</h3>
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm text-foreground">Safety Inspection</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="p-6 border border-border rounded-lg hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-foreground">#IR-005</h3>
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">Type:</span>
                    <span className="text-sm text-foreground">Structural Inspection</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">Approved By:</span>
              ...
              <div className="p-6 border border-border rounded-lg hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-foreground">#IR-006</h3>
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">Type:</span>
                    <span className="text-sm text-foreground">Quality Inspection</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">Approved By:</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-card rounded-xl p-6 shadow-card">
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground">Total IRs</div>
              </div>
            </div>
        ...
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-6">Inspection Types Overview</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-card rounded-xl p-6 shadow-card">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-foreground">Structural</h3>
                  <p className="text-sm text-muted-foreground">Building structure</p>
                </div>
              </div>
            ...
            <div className="bg-card rounded-xl p-6 shadow-card">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Environmental compliance</p>
                </div>
              </div>
